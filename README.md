...
GRANT ALL PRIVILEGES ON *.* TO 'user_lalande_datastore_001_loc'@'%' WITH GRANT OPTION;
FLUSH PRIVILEGES;

## 2.4. Crear base de datos:

CREATE DATABASE IF NOT EXISTS `db_lalande_datastore_communication`
...
## 2.7. Ubicar en la base de datos:
